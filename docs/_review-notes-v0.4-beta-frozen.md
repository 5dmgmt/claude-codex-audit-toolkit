# v0.4-beta 凍結時の未反映 finding (R5-R6 時点)

> 2026-04-28 / R5 自己監査 P1×12 のうち構造バグ・実用ガード **7 件反映 + 残 5 件凍結** → R6 で凍結方針の機能を確認。R6 P1×8 はすべて R5 反映の波及漏れ・構造的精緻化要求 (凍結項目への再指摘はゼロ) で **全件反映**。v1.0 で外部事例の知見を踏まえて再判定するのは下記 5 件のみ。
