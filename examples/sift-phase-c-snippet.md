...
> 件数は memory + 当時のラウンドログから抽出した概数。R3 = 18 件と R13 = ALL PASS は記録に明示があるが、R5/R6 の細目は推定を含みます。
...
これにより R12 まで残っていた dev bypass 系の指摘がゼロ化。R13 では他軸の指摘もすべて反映済で ALL PASS に到達しました。
